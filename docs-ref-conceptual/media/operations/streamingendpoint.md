...
|`FreeTrialEndTime`<br /> Read-only.<br /><br />This property was added in Media Services 2.15.|Edm.DateTime|When a new media services account gets created, a default standard streaming endpoint also automatically gets provisioned  under the account, in stopped state. |
