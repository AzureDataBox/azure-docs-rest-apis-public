...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested node health information.<br/> | [ApplicationHealth](sfclient-v56-model-applicationhealth.md) |
