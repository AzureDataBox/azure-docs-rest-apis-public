...
| [ClusterHealthPolicies](#clusterhealthpolicies) | [ClusterHealthPolicies](sfclient-v61-model-clusterhealthpolicies.md) | No | Body |
...
__Type__: [ClusterHealthPolicies](sfclient-v61-model-clusterhealthpolicies.md) <br/>
__Required__: No<br/>
<br/>
