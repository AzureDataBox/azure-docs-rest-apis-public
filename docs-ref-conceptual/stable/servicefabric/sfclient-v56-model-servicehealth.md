...
| [Name](#name) | string | No |
| [PartitionHealthStates](#partitionhealthstates) | array of [PartitionHealthState](sfclient-v56-model-partitionhealthstate.md) | No |
...
__Type__: array of [PartitionHealthState](sfclient-v56-model-partitionhealthstate.md) <br/>
__Required__: No<br/>
<br/>
