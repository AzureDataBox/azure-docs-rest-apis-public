...
| [PartitionFilters](#partitionfilters) | array of [PartitionHealthStateFilter](sfclient-v56-model-partitionhealthstatefilter.md) | No |
...
____
### PartitionFilters
__Type__: array of [PartitionHealthStateFilter](sfclient-v56-model-partitionhealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
