...
| [CreateComposeDeploymentDescription](#createcomposedeploymentdescription) | [CreateComposeDeploymentDescription](sfclient-v60-model-createcomposedeploymentdescription.md) | Yes | Body |
...
__Type__: [CreateComposeDeploymentDescription](sfclient-v60-model-createcomposedeploymentdescription.md) <br/>
__Required__: Yes<br/>
<br/>
