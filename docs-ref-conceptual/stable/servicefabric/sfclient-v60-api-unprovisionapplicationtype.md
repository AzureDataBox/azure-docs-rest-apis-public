...
| [ApplicationTypeImageStoreVersion](#applicationtypeimagestoreversion) | [ApplicationTypeImageStoreVersion](sfclient-v60-model-applicationtypeimagestoreversion.md) | Yes | Body |
...
__Type__: [ApplicationTypeImageStoreVersion](sfclient-v60-model-applicationtypeimagestoreversion.md) <br/>
__Required__: Yes<br/>
<br/>
