...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested provisioned code versions information.<br/> | array of [FabricCodeVersionInfo](sfclient-v60-model-fabriccodeversioninfo.md) |
