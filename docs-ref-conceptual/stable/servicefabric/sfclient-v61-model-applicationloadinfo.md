...
| [ApplicationLoadMetricInformation](#applicationloadmetricinformation) | array of [ApplicationMetricDescription](sfclient-v61-model-applicationmetricdescription.md) | No |
...
__Type__: array of [ApplicationMetricDescription](sfclient-v61-model-applicationmetricdescription.md) <br/>
__Required__: No<br/>
<br/>
