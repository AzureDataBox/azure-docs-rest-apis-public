...
| Kind | Derived Type |
| --- | --- | 
| Successful | [SuccessfulPropertyBatchInfo](sfclient-model-successfulpropertybatchinfo.md) |
| Failed | [FailedPropertyBatchInfo](sfclient-model-failedpropertybatchinfo.md) |
