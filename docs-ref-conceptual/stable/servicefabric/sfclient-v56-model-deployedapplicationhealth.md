...
| [DeployedServicePackageHealthStates](#deployedservicepackagehealthstates) | array of [DeployedServicePackageHealthState](sfclient-v56-model-deployedservicepackagehealthstate.md) | No |
...
__Type__: array of [DeployedServicePackageHealthState](sfclient-v56-model-deployedservicepackagehealthstate.md) <br/>
__Required__: No<br/>
<br/>
