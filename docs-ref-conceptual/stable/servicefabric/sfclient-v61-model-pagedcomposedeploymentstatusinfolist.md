...
| [Items](#items) | array of [ComposeDeploymentStatusInfo](sfclient-v61-model-composedeploymentstatusinfo.md) | No |
...
____
### Items
__Type__: array of [ComposeDeploymentStatusInfo](sfclient-v61-model-composedeploymentstatusinfo.md) <br/>
__Required__: No<br/>
<br/>
