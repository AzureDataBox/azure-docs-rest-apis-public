...
| [NodeDeactivationTask](#nodedeactivationtask) | array of [NodeDeactivationTask](sfclient-v56-model-nodedeactivationtask.md) | No |
| [PendingSafetyChecks](#pendingsafetychecks) | array of [SafetyCheckWrapper](sfclient-v56-model-safetycheckwrapper.md) | No |
...
__Type__: array of [NodeDeactivationTask](sfclient-v56-model-nodedeactivationtask.md) <br/>
__Required__: No<br/>
<br/>
...
____
### PendingSafetyChecks
__Type__: array of [SafetyCheckWrapper](sfclient-v56-model-safetycheckwrapper.md) <br/>
__Required__: No<br/>
<br/>
