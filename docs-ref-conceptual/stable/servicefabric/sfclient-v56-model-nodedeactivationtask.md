...
| Name | Type | Required |
| --- | --- | --- |
| [NodeDeactivationTaskId](#nodedeactivationtaskid) | [NodeDeactivationTaskId](sfclient-v56-model-nodedeactivationtaskid.md) | No |
| [NodeDeactivationIntent](#nodedeactivationintent) | string (enum) | No |

____
### NodeDeactivationTaskId
__Type__: [NodeDeactivationTaskId](sfclient-v56-model-nodedeactivationtaskid.md) <br/>
__Required__: No<br/>
<br/>
