...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the list of deployed service packages information.<br/> | array of [DeployedServicePackageInfo](sfclient-v56-model-deployedservicepackageinfo.md) |
