...
| [Items](#items) | array of [ServicePartitionInfo](sfclient-v56-model-servicepartitioninfo.md) | No |
...
____
### Items
__Type__: array of [ServicePartitionInfo](sfclient-v56-model-servicepartitioninfo.md) <br/>
__Required__: No<br/>
<br/>
