...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster configuration information.<br/> | [ClusterConfiguration](sfclient-v61-model-clusterconfiguration.md) |
