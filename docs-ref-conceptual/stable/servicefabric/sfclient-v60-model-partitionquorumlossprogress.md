...
| [InvokeQuorumLossResult](#invokequorumlossresult) | [InvokeQuorumLossResult](sfclient-v60-model-invokequorumlossresult.md) | No |
...
__Type__: [InvokeQuorumLossResult](sfclient-v60-model-invokequorumlossresult.md) <br/>
__Required__: No<br/>
<br/>
