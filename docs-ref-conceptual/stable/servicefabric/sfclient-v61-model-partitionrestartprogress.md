...
| [RestartPartitionResult](#restartpartitionresult) | [RestartPartitionResult](sfclient-v61-model-restartpartitionresult.md) | No |
...
__Type__: [RestartPartitionResult](sfclient-v61-model-restartpartitionresult.md) <br/>
__Required__: No<br/>
<br/>
