...
| 204 (NoContent) | An empty response is returned if the specified service package from the application is not deployed on the node.<br/> | array of [DeployedServicePackageInfo](sfclient-v61-model-deployedservicepackageinfo.md) |
