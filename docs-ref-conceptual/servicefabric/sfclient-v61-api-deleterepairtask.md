...
| [RepairTaskDeleteDescription](#repairtaskdeletedescription) | [RepairTaskDeleteDescription](sfclient-v61-model-repairtaskdeletedescription.md) | Yes | Body |
...
__Type__: [RepairTaskDeleteDescription](sfclient-v61-model-repairtaskdeletedescription.md) <br/>
__Required__: Yes<br/>
<br/>
