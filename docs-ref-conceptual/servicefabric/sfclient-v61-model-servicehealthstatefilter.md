...
| [PartitionFilters](#partitionfilters) | array of [PartitionHealthStateFilter](sfclient-v61-model-partitionhealthstatefilter.md) | No |
...
____
### PartitionFilters
__Type__: array of [PartitionHealthStateFilter](sfclient-v61-model-partitionhealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
