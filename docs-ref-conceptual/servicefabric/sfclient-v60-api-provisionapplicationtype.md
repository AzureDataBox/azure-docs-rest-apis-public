...
| [ApplicationTypeImageStorePath](#applicationtypeimagestorepath) | [ApplicationTypeImageStorePath](sfclient-v60-model-applicationtypeimagestorepath.md) | Yes | Body |
...
__Type__: [ApplicationTypeImageStorePath](sfclient-v60-model-applicationtypeimagestorepath.md) <br/>
__Required__: Yes<br/>
<br/>
