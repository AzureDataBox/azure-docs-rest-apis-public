...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested replica health information.<br/> | [ReplicaHealth](sfclient-v61-model-replicahealth.md) |
