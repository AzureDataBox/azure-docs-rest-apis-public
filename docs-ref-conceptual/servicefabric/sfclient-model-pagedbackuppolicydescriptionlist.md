...
| [`Items`](#items) | array of [BackupPolicyDescription](sfclient-model-backuppolicydescription.md) | No |
...
____
### `Items`
__Type__: array of [BackupPolicyDescription](sfclient-model-backuppolicydescription.md) <br/>
__Required__: No<br/>
<br/>
