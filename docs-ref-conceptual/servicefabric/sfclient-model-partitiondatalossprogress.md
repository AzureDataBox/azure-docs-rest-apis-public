...
| [`InvokeDataLossResult`](#invokedatalossresult) | [InvokeDataLossResult](sfclient-model-invokedatalossresult.md) | No |
...
__Type__: [InvokeDataLossResult](sfclient-model-invokedatalossresult.md) <br/>
__Required__: No<br/>
<br/>
