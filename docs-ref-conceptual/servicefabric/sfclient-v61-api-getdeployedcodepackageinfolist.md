...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the list of deployed code packages information.<br/> | array of [DeployedCodePackageInfo](sfclient-v61-model-deployedcodepackageinfo.md) |
