...
| Name | Type | Required |
| --- | --- | --- |
| [HealthStateCountList](#healthstatecountlist) | array of [EntityKindHealthStateCount](sfclient-v61-model-entitykindhealthstatecount.md) | No |

____
### HealthStateCountList
__Type__: array of [EntityKindHealthStateCount](sfclient-v61-model-entitykindhealthstatecount.md) <br/>
__Required__: No<br/>
<br/>
