...
| [ReplicaFilters](#replicafilters) | array of [ReplicaHealthStateFilter](sfclient-v60-model-replicahealthstatefilter.md) | No |
...
____
### ReplicaFilters
__Type__: array of [ReplicaHealthStateFilter](sfclient-v60-model-replicahealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
