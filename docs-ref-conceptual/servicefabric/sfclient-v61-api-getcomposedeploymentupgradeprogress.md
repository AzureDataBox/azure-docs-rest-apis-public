...
| --- | --- | --- |
| 200 (OK) | Details about the compose deployment upgrade.<br/> | [ComposeDeploymentUpgradeProgressInfo](sfclient-v61-model-composedeploymentupgradeprogressinfo.md) |
