...
| [NodeHealthStateChunks](#nodehealthstatechunks) | [NodeHealthStateChunkList](sfclient-v60-model-nodehealthstatechunklist.md) | No |
| [ApplicationHealthStateChunks](#applicationhealthstatechunks) | [ApplicationHealthStateChunkList](sfclient-v60-model-applicationhealthstatechunklist.md) | No |
...
__Type__: [NodeHealthStateChunkList](sfclient-v60-model-nodehealthstatechunklist.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [ApplicationHealthStateChunkList](sfclient-v60-model-applicationhealthstatechunklist.md) <br/>
__Required__: No<br/>
<br/>
