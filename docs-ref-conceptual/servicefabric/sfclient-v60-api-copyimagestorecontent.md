...
| [ImageStoreCopyDescription](#imagestorecopydescription) | [ImageStoreCopyDescription](sfclient-v60-model-imagestorecopydescription.md) | Yes | Body |
...
__Type__: [ImageStoreCopyDescription](sfclient-v60-model-imagestorecopydescription.md) <br/>
__Required__: Yes<br/>
<br/>
