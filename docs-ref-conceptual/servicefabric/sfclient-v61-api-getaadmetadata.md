...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the Azure Active Directory metadata.<br/> | [AadMetadataObject](sfclient-v61-model-aadmetadataobject.md) |
