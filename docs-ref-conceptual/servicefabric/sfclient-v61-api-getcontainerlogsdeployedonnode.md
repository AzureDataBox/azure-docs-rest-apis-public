...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the container logs for container deployed on a Service Fabric node for the given code package.<br/> | [ContainerLogs](sfclient-v61-model-containerlogs.md) |
