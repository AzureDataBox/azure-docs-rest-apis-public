...
| [Name](#name) | string | No |
| [ServiceHealthStates](#servicehealthstates) | array of [ServiceHealthState](sfclient-v61-model-servicehealthstate.md) | No |
| [DeployedApplicationHealthStates](#deployedapplicationhealthstates) | array of [DeployedApplicationHealthState](sfclient-v61-model-deployedapplicationhealthstate.md) | No |
...
____
### ServiceHealthStates
__Type__: array of [ServiceHealthState](sfclient-v61-model-servicehealthstate.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [DeployedApplicationHealthState](sfclient-v61-model-deployedapplicationhealthstate.md) <br/>
__Required__: No<br/>
<br/>
