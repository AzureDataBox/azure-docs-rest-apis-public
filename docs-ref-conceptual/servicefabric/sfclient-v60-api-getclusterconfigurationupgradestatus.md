...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster configuration upgrade status.<br/> | [ClusterConfigurationUpgradeStatusInfo](sfclient-v60-model-clusterconfigurationupgradestatusinfo.md) |
