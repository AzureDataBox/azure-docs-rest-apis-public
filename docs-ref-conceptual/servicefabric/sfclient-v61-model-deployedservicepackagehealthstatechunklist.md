...
| Name | Type | Required |
| --- | --- | --- |
| [Items](#items) | array of [DeployedServicePackageHealthStateChunk](sfclient-v61-model-deployedservicepackagehealthstatechunk.md) | No |

____
### Items
__Type__: array of [DeployedServicePackageHealthStateChunk](sfclient-v61-model-deployedservicepackagehealthstatechunk.md) <br/>
__Required__: No<br/>
<br/>
