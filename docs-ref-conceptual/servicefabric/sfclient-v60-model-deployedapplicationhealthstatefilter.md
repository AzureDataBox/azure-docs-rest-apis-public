...
| [DeployedServicePackageFilters](#deployedservicepackagefilters) | array of [DeployedServicePackageHealthStateFilter](sfclient-v60-model-deployedservicepackagehealthstatefilter.md) | No |
...
__Type__: array of [DeployedServicePackageHealthStateFilter](sfclient-v60-model-deployedservicepackagehealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
