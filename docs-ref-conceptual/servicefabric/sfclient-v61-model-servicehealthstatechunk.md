...
| [PartitionHealthStateChunks](#partitionhealthstatechunks) | [PartitionHealthStateChunkList](sfclient-v61-model-partitionhealthstatechunklist.md) | No |
...
__Type__: [PartitionHealthStateChunkList](sfclient-v61-model-partitionhealthstatechunklist.md) <br/>
__Required__: No<br/>
<br/>
