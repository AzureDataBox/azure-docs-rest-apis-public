...
| [PackageSharingPolicy](#packagesharingpolicy) | array of [PackageSharingPolicyInfo](sfclient-v61-model-packagesharingpolicyinfo.md) | No |
...
__Type__: array of [PackageSharingPolicyInfo](sfclient-v61-model-packagesharingpolicyinfo.md) <br/>
__Required__: No<br/>
<br/>
