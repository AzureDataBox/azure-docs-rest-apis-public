...
| [DeployedServiceReplicaQueryResult](#deployedservicereplicaqueryresult) | [DeployedStatelessServiceInstanceInfo](sfclient-v61-model-deployedstatelessserviceinstanceinfo.md) | No |
...
__Type__: [DeployedStatelessServiceInstanceInfo](sfclient-v61-model-deployedstatelessserviceinstanceinfo.md) <br/>
__Required__: No<br/>
<br/>
