...
| --- | --- | --- |
| 200 (OK) | Information about the progress of a partition quorum loss operation.<br/> | [PartitionQuorumLossProgress](sfclient-v56-model-partitionquorumlossprogress.md) |
