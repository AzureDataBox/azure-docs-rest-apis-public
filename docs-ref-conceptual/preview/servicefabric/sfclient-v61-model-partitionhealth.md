...
| [ReplicaHealthStates](#replicahealthstates) | array of [ReplicaHealthState](sfclient-v61-model-replicahealthstate.md) | No |
...
____
### ReplicaHealthStates
__Type__: array of [ReplicaHealthState](sfclient-v61-model-replicahealthstate.md) <br/>
__Required__: No<br/>
<br/>
