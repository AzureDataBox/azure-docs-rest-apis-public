...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster manifest information.<br/> | [ClusterManifest](sfclient-v61-model-clustermanifest.md) |
