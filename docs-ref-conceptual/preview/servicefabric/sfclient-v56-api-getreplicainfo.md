...
| Method | Request URI |
| ------ | ----------- |
| GET | `/Partitions/{partitionId}/$/GetReplicas/{replicaId}?api-version=3.0&ContinuationToken={ContinuationToken}&timeout={timeout}` |
...
| --- | --- | --- |
| 200 (OK) | Information about the specified replicas of the specified partition of a Service Fabric service.<br/> | [ReplicaInfo](sfclient-v56-model-replicainfo.md) |
