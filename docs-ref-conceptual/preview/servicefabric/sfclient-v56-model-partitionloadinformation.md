...
| [PrimaryLoadMetricReports](#primaryloadmetricreports) | array of [LoadMetricReport](sfclient-v56-model-loadmetricreport.md) | No |
| [SecondaryLoadMetricReports](#secondaryloadmetricreports) | array of [LoadMetricReport](sfclient-v56-model-loadmetricreport.md) | No |
...
__Type__: array of [LoadMetricReport](sfclient-v56-model-loadmetricreport.md) <br/>
__Required__: No<br/>
<br/>
