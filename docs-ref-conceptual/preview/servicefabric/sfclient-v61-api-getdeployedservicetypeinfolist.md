...
| --- | --- | --- |
| 200 (OK) | List of information about service types of an application deployed on a node.<br/> | array of [DeployedServiceTypeInfo](sfclient-v61-model-deployedservicetypeinfo.md) |
