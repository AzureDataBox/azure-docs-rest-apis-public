...
| --- | --- | --- |
| 200 (OK) | Information about service types of an application deployed on a node.<br/> | array of [DeployedServiceTypeInfo](sfclient-v60-model-deployedservicetypeinfo.md) |
