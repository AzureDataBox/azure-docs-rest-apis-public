...
| [ReplicaHealthStateChunks](#replicahealthstatechunks) | [ReplicaHealthStateChunkList](sfclient-v56-model-replicahealthstatechunklist.md) | No |
...
__Type__: [ReplicaHealthStateChunkList](sfclient-v56-model-replicahealthstatechunklist.md) <br/>
__Required__: No<br/>
<br/>
