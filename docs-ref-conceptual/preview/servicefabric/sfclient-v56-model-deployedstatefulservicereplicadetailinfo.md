...
| [ReportedLoad](#reportedload) | array of [LoadMetricReportInfo](sfclient-v56-model-loadmetricreportinfo.md) | No |
...
| [ReplicatorStatus](#replicatorstatus) | [ReplicatorStatus](sfclient-v56-model-replicatorstatus.md) | No |
| [ReplicaStatus](#replicastatus) | [KeyValueStoreReplicaStatus](sfclient-v56-model-keyvaluestorereplicastatus.md) | No |
...
____
### ReportedLoad
__Type__: array of [LoadMetricReportInfo](sfclient-v56-model-loadmetricreportinfo.md) <br/>
__Required__: No<br/>
<br/>
...
____
### ReplicatorStatus
__Type__: [ReplicatorStatus](sfclient-v56-model-replicatorstatus.md) <br/>
__Required__: No<br/>
<br/>
...
____
### ReplicaStatus
__Type__: [KeyValueStoreReplicaStatus](sfclient-v56-model-keyvaluestorereplicastatus.md) <br/>
__Required__: No<br/>
<br/>
