...
| [InvokeQuorumLossResult](#invokequorumlossresult) | [InvokeQuorumLossResult](sfclient-v56-model-invokequorumlossresult.md) | No |
...
__Type__: [InvokeQuorumLossResult](sfclient-v56-model-invokequorumlossresult.md) <br/>
__Required__: No<br/>
<br/>
