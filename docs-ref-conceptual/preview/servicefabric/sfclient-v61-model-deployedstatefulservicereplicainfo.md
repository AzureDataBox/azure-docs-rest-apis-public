...
| [ReconfigurationInformation](#reconfigurationinformation) | [ReconfigurationInformation](sfclient-v61-model-reconfigurationinformation.md) | No |
...
__Type__: [ReconfigurationInformation](sfclient-v61-model-reconfigurationinformation.md) <br/>
__Required__: No<br/>
<br/>
