...
| [ApplicationMetrics](#applicationmetrics) | array of [ApplicationMetricDescription](sfclient-v56-model-applicationmetricdescription.md) | No |
...
____
### ApplicationMetrics
__Type__: array of [ApplicationMetricDescription](sfclient-v56-model-applicationmetricdescription.md) <br/>
__Required__: No<br/>
<br/>
