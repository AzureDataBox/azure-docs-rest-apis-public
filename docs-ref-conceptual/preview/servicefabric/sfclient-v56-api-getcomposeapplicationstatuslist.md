...
| --- | --- | --- |
| 200 (OK) | List of status of compose applications ins the cluster.<br/> | [PagedComposeApplicationStatusInfoList](sfclient-v56-model-pagedcomposeapplicationstatusinfolist.md) |
