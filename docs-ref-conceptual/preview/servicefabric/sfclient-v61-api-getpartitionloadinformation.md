...
| --- | --- | --- |
| 200 (OK) | Information about the specified partition's last reported load metrics.<br/> | [PartitionLoadInformation](sfclient-v61-model-partitionloadinformation.md) |
